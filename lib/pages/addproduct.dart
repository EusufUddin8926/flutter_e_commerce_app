...
class _AddFarmerProductPageState extends State<AddFarmerProductPage> {
  ...
  void _submitForm() async {
    ...
    if (selectedProductId == null || selectedProductData == null) {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('পণ্য সিলেক্ট করুন')));
      return;
    }
    ...
    try {
      ...
      if (productData != null) {
        ...
        if (isOwnerExist) {
          EasyLoading.dismiss();
          ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('পণ্যটি ইতিমধ্যে রয়েছে')));
          setState(() {
